...
```{r viewdata, exercise=TRUE, exercise.eval=FALSE, warning=FALSE}
...
```{r basicscatter, exercise=TRUE, exercise.eval=TRUE, echo=TRUE, include=TRUE, warning=FALSE}
...
```{r prettyscatter, exercise=TRUE, exercise.eval=TRUE, echo=TRUE, include=TRUE, message=FALSE, warning=FALSE}
...
```{r bestfit, exercise=TRUE, exercise.eval=TRUE, echo=TRUE, include=TRUE, message=FALSE, warning=FALSE, exercise.lines=25}
...
```{r layout-scatter, exercise=TRUE, exercise.eval=TRUE, echo=TRUE, include=TRUE, message=FALSE, warning=FALSE, exercise.lines=30}
# Necessary to repeat code for plot_2 because of how the html document works (see below)
plot_2 <- plot_ly(data = schoolData, x = ~avg_test_math_8_std, y = ~pct_4yr, mode = "markers", type="scatter",
                    marker = list(size=10,
                                  color = "steelblue",
...
```{r basic-bar, exercise=TRUE, exercise.eval=FALSE}
...
```{r bar-add-trace, exercise=TRUE, exercise.eval=FALSE}
...
```{r bar-stack, exercise=TRUE, exercise.eval=FALSE, exercise.lines=20}
# bar_1 complete or add your code here
bar_1 <- plot_ly(data = schoolData, x = ~order_4yr, y = ~pct_4yr, type="bar", name="Seamless",
                  text = ~paste(
                    "School: ", schoolData$last_hs_name, "<br>",
...
```{r bar-layout, exercise=TRUE, exercise.eval=FALSE, exercise.lines=30}
# bar_1 complete or add your code here
bar_1 <- plot_ly(data = schoolData, x = ~order_4yr, y = ~pct_4yr, type="bar", name="Seamless",
                  text = ~paste(
                    "School: ", schoolData$last_hs_name, "<br>",
...
```{r scatter-function, exercise=TRUE, exercise.eval=TRUE, echo=TRUE, include=TRUE, message=FALSE, warning=FALSE, exercise.lines=30}
...
```{r bar-function, exercise=TRUE, exercise.eval=FALSE, echo=TRUE, include=TRUE, message=FALSE, warning=FALSE, exercise.lines=30}
